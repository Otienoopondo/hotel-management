// Home Page with logo, header, hamburger menu, and help button restored
...
export default function Home() {
  ...
  const hotels = [
    {
      name: "PrideInn Paradise Beach Resort & Spa Mombasa",
      base: "hotel1",
      desc: "Beachfront luxury resort in Shanzu.",
      price: "Kshs 15,000",
      rating: 5,
    },
    {
      name: "Baobab Holiday Resort",
      base: "hotel2",
      desc: "Affordable and family-friendly.",
      price: "Kshs 13,000",
      rating: 4.5,
    },
    {
      name: "Cocoa Luxury Resort, Nyali, Mombasa",
      base: "hotel3",
      desc: "Stylish retreat with ocean views.",
      price: "Kshs 11,500",
      rating: 4,
    },
    {
      ...
      base: "hotel4",
      desc: "Elegant marina-side living.",
      price: "Kshs 12,000",
      rating: 4.5,
    },
    {
      name: "Hotel Sapphire",
      base: "hotel5",
      desc: "Business-class hotel in the city.",
      price: "Kshs 10,000",
      rating: 4,
    },
    {
      name: "Travellers Beach and Hotel Club",
      base: "hotel6",
      desc: "All-inclusive seaside hotel.",
      price: "Kshs 9,500",
      rating: 3.5,
    },
    {
      name: "CityBlue CreekSide Hotel and Suites",
      base: "hotel7",
      desc: "Creek view suites and serene vibes.",
      price: "Kshs 14,000",
      rating: 5,
    },
    {
      name: "Nyali Reef Hotel",
      base: "hotel8",
      desc: "Classic beachfront experience.",
      price: "Kshs 8,500",
      rating: 4,
    },
    {
      ...
      base: "hotel9",
      desc: "World-class luxury spa resort.",
      price: "Kshs 9,000",
      rating: 4,
    },
    {
      ...
      base: "hotel10",
      desc: "Eco-friendly hotel on Bamburi Beach.",
      price: "Kshs 13,500",
      rating: 4.5,
    },
  ];
      ...
      <header className="bg-gray-800 py-4 shadow-md text-white">
        <div className="max-w-7xl mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-blue-400">Hotel Management System</h1>
          </div>
          ...
          <nav className="hidden md:flex gap-4 items-center text-sm sm:text-base">
            ...
            <button onClick={() => setDarkMode(!darkMode)} className="ml-2 px-2 py-1 bg-white text-black rounded hover:bg-yellow-300">{darkMode ? <FaSun /> : <FaMoon />}</button>
            <select value={role} onChange={(e) => setRole(e.target.value)} className="p-1 rounded border text-black">
              <option value="client">Client</option>
              <option value="staff">Staff</option>
              <option value="admin">Admin</option>
            </select>
            <Link href={getRoute(role).replace("login", "signup")} className="px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 inline-flex items-center gap-1"><FaUserPlus /> Sign Up</Link>
            <Link href={getRoute(role)} className="px-3 py-1 bg-green-600 text-white rounded hover:bg-green-700 inline-flex items-center gap-1"><FaSignInAlt /> Log In</Link>
          </nav>
        </div>
        {mobileMenuOpen && (
          <div className="md:hidden px-4 pb-4 flex flex-col gap-3 mt-2">
            <Link href="/" className="hover:text-yellow-300 inline-flex items-center gap-1"><FaHome /> Home</Link>
            <button onClick={() => setShowAbout(true)} className="hover:text-yellow-300 inline-flex items-center gap-1"><FaInfoCircle /> About</button>
            <button onClick={() => setShowContact(true)} className="hover:text-yellow-300 inline-flex items-center gap-1"><FaPhone /> Contact</button>
          </div>
          ...
          .map((hotel, index) => (
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-1 justify-between">
                <div>
                  <h3 className="text-xl font-bold text-blue-900 dark:text-white leading-snug mb-1">
                    {hotel.name}
                  </h3>
                  <p className="text-sm text-gray-700 dark:text-gray-300">
                    {hotel.desc}
                  </p>
                  <p className="text-md font-semibold text-green-700 dark:text-green-400 mt-1">
                    {hotel.price}
                  </p>
                ...
                <Link
                  href="/client/signup"
                  className="block text-center w-full bg-green-600 text-white py-2 mt-4 rounded hover:bg-green-700"
                >
                  Book Now
                </Link>
              </div>
